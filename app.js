  ...
  transactions: [
    {
      ...
      amount: 320.00,
      type: "credit",
      balanceAfter: 56705.41,
      account: "checking",
      counterpartyName: "Daniel Brooks"
    },
    {
      id: "TXN-900000000002",
      title: "Gas Station",
      ...
      amount: -25.00,
      type: "debit",
      balanceAfter: 56385.41,
      account: "checking",
      counterpartyName: "Olivia Smith"
    },
    {
      id: "TXN-900000000003",
      ...
      amount: -129.45,
      type: "debit",
      balanceAfter: 56410.41,
      account: "checking",
      counterpartyName: "Liam Johnson"
    },
    {
      id: "TXN-900000000004",
      ...
      amount: -45.99,
      type: "debit",
      balanceAfter: 56539.86,
      account: "checking",
      counterpartyName: "Emma Davis"
    },
    {
      id: "TXN-900000000005",
      title: "Coffee • Local",
      ...
      amount: -8.60,
      type: "debit",
      balanceAfter: 56585.85,
      account: "checking",
      counterpartyName: "Noah Wilson"
    },
    {
      id: "TXN-827401928471",
      ...
      amount: 1500.00,
      type: "credit",
      balanceAfter: 56594.45,
      account: "checking",
      counterpartyName: "Marcus Fields"
    },
    {
      id: "TXN-391827401928",
      ...
      amount: -2000.00,
      type: "debit",
      balanceAfter: 55094.45,
      account: "checking",
      counterpartyName: "Sofia Rivera"
    },
    {
      id: "TXN-102938475610",
      ...
      amount: 850.00,
      type: "credit",
      balanceAfter: 57094.45,
      account: "checking",
      counterpartyName: "Olivia Martinez"
    },
    {
      id: "TXN-582910293847",
      ...
      amount: -129.99,
      type: "debit",
      balanceAfter: 56244.45,
      account: "checking",
      counterpartyName: "Ethan Brown"
    }
  ],
  darkMode: false
};
...
function setupEventListeners() {
  ...
  if (transferForm) {
    transferForm.addEventListener('submit', (e) => {
      e.preventDefault();
      // Immediately show failure modal and block the transaction (per user request)
